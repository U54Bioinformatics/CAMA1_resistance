...
meta <- read.table("VG_CAMA1_D11_10x_cell_metadata.UMAPcluster.txt", sep="\t", header=T)
...
write.table(meta_groups.df, "VG_CAMA1_D11_10x_cell_metadata.UMAPcluster.cell_groups.violin.data.txt", sep="\t", quote=F, row.names=F, col.names=T)
write.table(crosstable, "VG_CAMA1_D11_10x_cell_metadata.UMAPcluster.cell_groups.crosstable.txt", sep="\t", quote=F, col.names=T)
...
pdf("VG_CAMA1_D11_10x_cell_metadata.UMAPcluster.cell_groups.violin.pdf", width=8, height=5)
x <- read.table("VG_CAMA1_D11_10x_cell_metadata.UMAPcluster.cell_groups.violin.data.txt", header = T, sep="\t")
#nCount_RNA
