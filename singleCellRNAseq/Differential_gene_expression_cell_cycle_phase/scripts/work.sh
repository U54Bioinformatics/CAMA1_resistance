...
echo "group mean for genes"
python Prepare_mean_from_matrix_and_anno.py --matrix VG_CAMA1_D11_ALL_10x_gene_symbols.CPM.txt --anno VG_CAMA1_D11_ALL_10x_cell_metadata.UMAPcluster.marker_genes.txt --group Marker_groups
python ~/software/bin/txt2xlsx.py --input VG_CAMA1_D11_ALL_10x_gene_symbols.CPM.group_mean_Marker_groups.txt

echo "cell cycle"
export R_LIBS=/home/jichen/software/BETSY/install/envs/scRNA/lib/R/library
cat VG_CAMA1_D11_ALL_10x_cell_number_vs_cell_cycle.R | /home/jichen/software/BETSY/install/envs/scRNA/bin/R --slave

echo "DE genes in each cell cycle phase"
export R_LIBS=/home/jichen/software/BETSY/install/envs/scRNA_MAST/lib/R/library
scRNA_Seurat_05individual_from_individual_cellcycle.sh

#enrichment plots, comparison 4
bash scRNA_Seurat_05individual_from_individual_DE_genes.sh > scRNA_Seurat_05individual_from_individual_DE_genes.comparison4.log 2>&1 &
